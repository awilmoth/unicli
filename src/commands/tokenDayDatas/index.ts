...
export default class tokenDayDatas extends Command {
  ...
  async run() {
    const { flags } = this.parse(tokenDayDatas);
    await handler({ command: this, query: TokenDayDatasDocument, variables: flags });
  }
}
