...
query liquidityPositions($skip: Int, $first: Int, $orderBy: PairDayData_orderBy, $orderDirection: OrderDirection, $where: PairDayData_filter, $skip1: Int, $first1: Int, $orderBy1: PairDayData_orderBy, $orderDirection1: OrderDirection, $where1: PairDayData_filter, $skip2: Int, $first2: Int, $orderBy2: LiquidityPosition_orderBy, $orderDirection2: OrderDirection, $where2: LiquidityPosition_filter, $skip3: Int, $first3: Int, $orderBy3: LiquidityPosition_orderBy, $orderDirection3: OrderDirection, $where3: LiquidityPosition_filter, $block: Block_height) {
  liquidityPositions(
    skip: $skip3
    first: $first3
    orderBy: $orderBy3
...
export default class liquidityPositions extends Command {
  ...
  async run() {
    const { flags } = this.parse(liquidityPositions);
    await handler({ command: this, query: LiquidityPositionsDocument, variables: flags });
  }
}
